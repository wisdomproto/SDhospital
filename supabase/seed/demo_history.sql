...
-- ── 7. 병원 소식 (보호자 앱 첫 화면) ──────────────────────────
-- 하나는 진행 중, 하나는 아직 시작 전. RLS 가 기간 밖 소식을 알아서 감추는 것을 데모에서 보여준다.
insert into notice (id, title, body, starts_on, ends_on, pinned) values
('d0000000-0000-4000-8000-000005000001', '8월 심장사상충 예방 캠페인',
 E'8월 한 달간 심장사상충 검사비를 지원해 드립니다.
예방약 3개월분을 구매하시면 1개월분을 더 드려요.',
 '2026-07-20', '2026-08-31', true),
('d0000000-0000-4000-8000-000005000002', '가을 건강검진 사전 예약 안내',
 E'9월 건강검진 예약을 받고 있습니다. 7세 이상 아이는 혈액·초음파 검진을 함께 권해드려요.
예약은 병원으로 전화 주세요.',
 '2026-07-25', '2026-09-30', false),
('d0000000-0000-4000-8000-000005000003', '추석 연휴 진료 안내',
 E'추석 당일은 휴진하고, 나머지 연휴에는 오전 진료만 합니다.
입원 중인 아이들은 평소처럼 돌봅니다.',
 '2026-09-15', '2026-09-30', false)
on conflict (id) do nothing;
