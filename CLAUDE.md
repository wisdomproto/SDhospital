...
- **보호자 채팅** — `2026-08-03-owner-chat.md`. 실제 상담 105건(12,738 메시지) 분석 결과
  **의학 질문은 4.4% 뿐**이고 1위는 예약(203건)이다. 응답 속도는 이미 10분 내 86%라 개선 여지가 없다.
  그래서 AI 는 **의학 답변을 하지 않고**, 조회·FAQ·예약을 걷어낸 뒤 남는 것만 **직원에게 초안으로** 준다.
